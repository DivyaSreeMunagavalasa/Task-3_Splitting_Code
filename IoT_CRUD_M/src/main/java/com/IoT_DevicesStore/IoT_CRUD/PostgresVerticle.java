      ...
      try {
        ...
        databaseService.getClient().getConnection(res -> {
          if (res.succeeded()) {
            ...
            // Handle adding device to the database using connection
    ...
    vertx.eventBus().consumer("updateDevice", message -> {
      try {
        ...
        databaseService.getClient().getConnection(res -> {
          if (res.succeeded()) {
            SQLConnection connection = res.result();
            // Handle updating the device in the database using connection
            connection.updateWithParams(
      ...
      try {
        ...
        databaseService.getClient().getConnection(res -> {
          if (res.succeeded()) {
            ...
            // Handle fetching the device from the database using connection
      ...
      try {
        ...
        databaseService.getClient().getConnection(res -> {
          if (res.succeeded()) {
            ...
            // Handle deleting the device from the database using connection
            connection.updateWithParams(
